...
def do_it():
    ...
    s = Scene()
    s.add(ShapeGrob(Union(Circle(Vector(0.3, 0.1), 0.1),
                          Circle(Vector(0.35, 0.1), 0.1)),
                    Color(0,0,0,0.5)))
    s.add(ShapeGrob(Intersection(Circle(Vector(0.3, 0.3), 0.1),
                                 Circle(Vector(0.35, 0.3), 0.1)),
                    Color(0,0.5,0,1)))
    s.add(ShapeGrob(Subtraction(Circle(Vector(0.3, 0.5), 0.1),
                                Circle(Vector(0.35, 0.5), 0.1)),
                    Color(0,0,0.5,1)))
    s.add(ShapeGrob(Subtraction(Circle(Vector(0.35, 0.7), 0.1),
